package io.github.onedashboard.inspirationforge.exception;
...
public class GlobalExceptionHandler {
    ...
    private boolean handleSseError(int errorCode, String errorMessage) {
        ...
        if ((accept != null && accept.contains("text/event-stream")) ||
                uri.contains("/chat/gen/code") || uri.contains("/chat/task/stream")
                        || uri.contains("/chat/resume") || uri.contains("/chat/repair/build")) {
            try {
                // 设置SSE响应头
