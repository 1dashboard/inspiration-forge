...
import io.github.onedashboard.inspirationforge.model.dto.user.UserQueryRequest;
import io.github.onedashboard.inspirationforge.model.entity.User;
import io.github.onedashboard.inspirationforge.mapper.UserMapper;
import io.github.onedashboard.inspirationforge.model.enums.UserRoleEnum;
import io.github.onedashboard.inspirationforge.model.vo.LoginUserVO;
...
import static io.github.onedashboard.inspirationforge.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String getEncryptPassword(String userPassword) {
        return DigestUtils.md5DigestAsHex((userPassword + passwordSalt).getBytes(StandardCharsets.UTF_8));
    }
}
